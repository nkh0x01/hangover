...
4. **პერსონალიზებული რეკლამა:** ამჟამინდელი ბილდი მომხმარებელს თვალს **არ**
   ადევნებს და შესაბამისი ნებართვის გასაღები Info.plist-ში **არ არის**. თუ
   მომავალში პერსონალიზებულ რეკლამას დაამატებ, ჩაამატე საჭირო ნებართვის გასაღები
   და მოითხოვე თანხმობა შესაბამისი სისტემური API-ით.
