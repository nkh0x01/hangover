  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
          ...
          builder: (_, __) => const DestinationPage()),
      GoRoute(
          path: '/ride/search',
          builder: (_, __) => const DestinationSearchPage()),
      GoRoute(
          path: '/ride/estimate', builder: (_, __) => const FareEstimatePage()),
      GoRoute(
        path: '/ride/:id',
        builder: (_, state) =>
            RideTrackingPage(rideId: state.pathParameters['id']!),
      ),
    ],
